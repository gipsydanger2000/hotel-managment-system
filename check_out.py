...
def create_pdf(bill, amount):
    pdf = FPDF()
    print(bill)
    pdf.add_page()

    pdf.set_font('Arial', 'B', 16)
    pdf.cell(40, 10, "Name : {} {} \n Room no : {}  \n Room Type : {} \n Number of days: {} \n ".format(*bill), ln=1, align="L")
    pdf.cell(40, 10, "Amount: {}".format(amount))
    pdf.output("Final Bill.pdf")
...
def click_proceed():
    ...
    if f_name == '' or l_name == '' or room_no == 0:
        ...
        text.delete('1.0', END)
        mydb = mysql.connector.connect(host='localhost', user='root', password='1234', database='hotel')
        cur = mydb.cursor()
